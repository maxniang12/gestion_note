...
<div class="wrapper collapse">
    ...
    <div class="main_content">
        ...
        <div class="item">
            ...
            <section>
                <div class="form-box">
                    <h2>Creation Module</h2>
                    <form action="ModuleServlet" method="post" id="formulaire">
                        <div id="form-body">
                            <div class="input-box">

                                <input type="text" id="code" name="code" placeholder="Donner le code du Module" required>
                            </div>
                            <div class="input-box">

                                <input type="text" id="intitule" name="intitule" placeholder="Donner l'intitulé" required>
                            </div>
                            <div class="input-box">

                                <input type="number" id="volumeHoraire" name="volumeHoraire" placeholder="Donner le volume horaire" required>
                            </div>
                            <div class="input-box">

                                <input type="number" id="coefficient" name="coefficient" step="1" placeholder="Donner le coefficient du Module" required>
                            </div>
                            <div class="input-box">
                                <input type="number" id="nombreCredits" name="nombreCredits" step="1" placeholder="Donner le nombre de crédits du Module" required>
                            </div>
                            <div class="input-box">

                                <input type="text" id="responsable" name="responsable" placeholder="Donner le code du responsable" required>
                            </div>
                            <button type="submit">Créer le Module</button>
                        </div>
                    </form>
                    <a href="listeModules.jsp" class="back-link">Retourner à la liste des Modules</a>
                </div>
            </section>
