...
<div class="form-container">
    ...
    <form action="ModifierEnseignantServlet" method="post">
        ...
        <input type="text" id="sexe" name="sexe" value="<%= sexe %>" required>
        ...
        <input type="email" id="adresseEmail" name="adresseEmail" value="<%= adresseEmail %>" required>

        <label for="bureau">Bureau:</label>
        <input type="text" id="bureau" name="bureau" value="<%= bureau %>" required>

        <label for="institutionRattachement">Institution de Rattachement:</label>
        <input type="text" id="institutionRattachement" name="institutionRattachement" value="<%= institutionRattachement %>" required>
