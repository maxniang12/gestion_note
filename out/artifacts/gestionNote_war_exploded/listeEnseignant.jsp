            ...
            <div class="container">
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td><%= rs.getString("bureau") %></td>
                        <td><%= rs.getString("institutionRattachement") %></td>
                        <td class="actions">
                            <a href="modifierEnseignant.jsp?matricule=<%= rs.getString("matricule") %>" class="modifier"  title="modifier un Enseignant"><i class="fa-solid fa-file-pen fa-beat"></i></a>
                            <form action="SupprimerEnseignantServlet" method="post" style="display:inline;">
                                <input type="hidden" name="matricule" value="<%= rs.getString("matricule") %>">
                                <button type="submit" class="btn btn-delete" title="supprimer un Enseignant" ><i class="fa-solid fa-trash-can fa-beat-fade"></i></button>
                            </form>
                        </td>
                    </tr>
                    <%
                ...
                <br>
                <a href="inscriptionEnseignant.jsp" class="ajouterbtn">Ajouter un autre</a>
