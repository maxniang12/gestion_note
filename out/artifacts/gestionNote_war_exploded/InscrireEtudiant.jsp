...
<html>
<head>
    <title>page inscription de l'etudiant</title>
            ...
            --%>
                ...
                <section>
                    <div class="form-box">
                        ...
                        <form action="EtudiantServlet" method="post" id="formulaire">
                            <div id="form-body">
                                <div class="input-box">
                                    <input type="text" id="INE" name="INE"  placeholder="donner INE de Etudiant" required>
                                </div>
                                <div class="input-box">
