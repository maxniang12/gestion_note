...
<div class="wrapper collapse">
    ...
    <div class="main_content">
        ...
        <div class="item">
            ...
            <div class="form-box">
                <h2>Attibution de notes</h2>
                <form action="EnregistrerServlet" method="post" id="formulaire">
                    <div id="form-body">
                        <div class="input-box">

                            <input type="text" id="moduleId" name="moduleId" placeholder="Donner le code du Module" required>
                        </div>
                        <div class="input-box">

                            <input type="text" id="etudiantId" name="etudiantId" placeholder="Donner INE de etudiant" required>
                        </div>
                        <div class="input-box">

                            <input type="number"  min="0"  max="20" step="0.1" name="noteControleContinu" id="noteControleContinu" placeholder="donner la note du controle continue" required>
                        </div>
                        <div class="input-box">

                            <input type="number"  min="0"  max="20" step="0.1" name="noteExamen" id="noteExamen" placeholder="donner la note de l'examen " required>
                        </div>
